...
def main():
    ...
    st.info("⚡ Versión mejorada: Hasta 1000 artículos | Flavors fusionados (3-4 grupos grandes)")
    ...
    **Características:**
    ...
    if st.session_state.docx_generated and st.session_state.docx_data is not None:
        ...
        with st.expander("📖 Guía de uso"):
            ...
            **Estructura del documento:**
            ...
            Cada flavor incluye un resumen detallado con citas como "(Autor (1))" y las referencias completas al final.
            """)
    ...
    st.markdown(
        ...
        <div style='text-align: center; color: gray; font-size: 0.8em;'>
            ...
            BioBERT NER | HDBSCAN + Fusión de clusters | Hasta 1000 artículos | 3-4 flavors grandes con ~15 referencias cada uno
        </div>
        """,
