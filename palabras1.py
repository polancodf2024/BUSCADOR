...
def terms_to_boolean(terms_str):
    ...
    Example input: "myocardial infarction, heart rupture, cardiac rupture"
...
def show_search_builder_tab():
    ...
    with col1:
        ...
        example_terms = "myocardial infarction, heart rupture, cardiac rupture, ventricular septal rupture, free wall rupture, intramyocardial dissecting hematoma"
        
        terms_input = st.text_area(
            "Terms:",
            value=example_terms,
            height=200,
            help="Example: myocardial infarction, heart rupture, cardiac rupture",
            key="builder_terms"
        )
    ...
    with col2:
        ...
        example_hypothesis = "intramyocardial dissections occurring as a complication of myocardial infarction follow predictable anatomical pathways along established tissue planes, with distinct patterns based on timing of presentation and location within the ventricular wall"
        
        hypothesis_input = st.text_area(
            "Hypothesis:",
            value=example_hypothesis,
            height=200,
            help="Example: intramyocardial dissections occurring as a complication...",
    ...
    with st.expander("📖 Help & Examples"):
        ...
        st.markdown("```\nmyocardial infarction, heart rupture, cardiac rupture, free wall rupture\n```")
        
        st.markdown("### Generated output:")
        st.markdown("```\n(\"myocardial infarction\"[Mesh] OR \"myocardial infarction\"[tiab]) AND (\"heart rupture\"[Mesh] OR \"heart rupture\"[tiab]) AND (\"cardiac rupture\"[Mesh] OR \"cardiac rupture\"[tiab]) AND (\"free wall rupture\"[Mesh] OR \"free wall rupture\"[tiab])\n```")
        
        st.markdown("### Example hypothesis:")
        st.markdown("**Input:** `intramyocardial dissections occurring as a complication of myocardial infarction follow predictable anatomical pathways`")
        st.markdown("**Output:** `Intramyocardial dissections occurring as a complication of myocardial infarction follow predictable anatomical pathways.`")
...
def main():
    ...
    with tab1:
        ...
        st.markdown("---")
        st.markdown("<div style='text-align: center; color: gray;'>PubMed AI Analyzer v32.0 | ✅ 2 BLOCKS OF 1000 | Block start and completion emails</div>", unsafe_allow_html=True)
